...
// </copyright>
// <author></author>
// <date>3/14/2022 2:39:58 PM</date>
...
namespace SpaceX_CustomDataProvider
{
    ...
    public abstract class RetrieveMultiplePlugin : IPlugin
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveMultiplePlugin"/> class.
        /// </summary>
            ...
            try
            {
                ...
                using (var s = webRequest.GetResponse().GetResponseStream())
                {
                    using (var sr = new StreamReader(s))
                    {
                        ...
                        localPluginContext.TracingService.Trace("Total number of Launches: {0}", launches.Count);
                        ec.Entities.AddRange(launches.Select(l => l.ToEntity(localPluginContext.TracingService)));
                    }
                }
            }
            catch (Exception e)
